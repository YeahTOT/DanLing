Create a single horizontal sprite strip for the Codex app digital pet `danling` in the state `running-right`.
...
DanLing state meaning: this row represents `normal`, for other healthy training states. Keep it steady and confident, like 丹灵 walking forward through routine work.
