Create a single horizontal sprite strip for the Codex app digital pet `danling` in the state `jumping`.
...
DanLing state meaning: this row represents `evolving`, when current score reaches a new high. Show a restrained breakthrough jump or light upward cultivation lift through body position only; no aura, glow, floor marks, detached sparkles, or shadows.
